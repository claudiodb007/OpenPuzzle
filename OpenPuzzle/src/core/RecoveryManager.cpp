...
static int extractInt(const std::string& text, const std::string& key, int defaultValue)
{
...
static std::uint64_t extractUInt64(const std::string& text, const std::string& key, std::uint64_t defaultValue)
{
    auto pos = text.find(key);
...
static double extractDouble(const std::string& text, const std::string& key, double defaultValue)
{
    auto pos = text.find(key);
